...
ProductRoutes.post("/add",Authentication,checkPermissions('product', 'create'), uploadFileMulter.array("images", 10), stringToArray("tags"), ProductController.addProduct)
