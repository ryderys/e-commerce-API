...
ReportRoutes.get("/all",adminAuthMiddleware,checkPermissions(APP_RESOURCES.Review, 'get'), ReportController.getReportedReviews) //admin
...
ReportRoutes.get("/:reportId", checkPermissions(APP_RESOURCES.Review, 'get'),ReportController.getReportById)
